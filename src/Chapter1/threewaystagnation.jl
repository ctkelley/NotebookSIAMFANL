...
function threewaystagnation(printlabel = true)
    ...
    kwnewt =
        (maxit = 14, rtol = 1.0e-17, atol = 1.0e-17, printerr = false, stagnationok = true)
    kwchord = (
        maxit = 14,
        rtol = 1.0e-17,
        atol = 1.0e-17,
    ...
    kwsec = (maxit = 6, rtol = 1.0e-17, atol = 1.0e-17, printerr = false, stagnationok = true)
    ...
    return ~printlabel || title("Figure 1.3 from print book")
end
